/*
 * TEMPORARY: Sukkot 2026 closure notice, homepage only (owner request, 2026-09-25).
 * Remove after the holiday: delete this file and the HOLIDAY-NOTICE sukkot-2026 block in /index.html.
 *
 ...
 * 2026-09-28 09:00 Eastern.
 */
(function () {
  "use strict";

  var END = Date.parse("2026-09-28T09:00:00-04:00");
  var ID = "bh-holiday-notice";
  var HREF = "/blog/sukkot-2026/";
  ...
  function build() {
    ...
    lead.appendChild(document.createTextNode("Closed for Sukkot."));
