/*
 * TEMPORARY: Yom Kippur 2026 closure notice, homepage only (owner request, 2026-09-20).
 ...
 * itself on client-side navigation away from "/", and never shows from Tuesday
 * 2026-09-22 09:00 Eastern.
 */
(function () {
  "use strict";
  ...
  function build() {
    ...
    lead.appendChild(document.createTextNode("Closed for Yom Kippur."));

    text.appendChild(lead);
    text.appendChild(document.createTextNode(
      " We are closed Sunday, September 20 and Monday, September 21, and reopen Tuesday, September 22 at 9:00 AM. Wishing everyone an easy and meaningful fast."
    ));
